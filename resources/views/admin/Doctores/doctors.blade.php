            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="{{route('admin.doctores.add-doctor')}}" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Agregar Doctor</a>
                    </div>
                </div>
                        ...
                        <div class="profile-widget">
                            ...
                            <div class="dropdown profile-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{route('admin.doctores.edit-doctor')}}"><i class="fa fa-pencil m-r-5"></i> Editar</a>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<h3>Quieres eliminar a este Doctor</h3>
